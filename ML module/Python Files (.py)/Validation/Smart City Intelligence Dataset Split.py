# ==========================================
# SMART CITY INTELLIGENCE DATASET SPLITTING
# ==========================================
...
print("=" * 60)
print("SMART CITY INTELLIGENCE DATASET SPLITTING")
print("=" * 60)
...
train_file = os.path.join(
    output_folder,
    "Smart_City_Intelligence_Train.csv"
)

validation_file = os.path.join(
    output_folder,
    "Smart_City_Intelligence_Validation.csv"
)

test_file = os.path.join(
    output_folder,
    "Smart_City_Intelligence_Test.csv"
)
...
print("\n" + "=" * 60)
print("SMART CITY SPLITTING COMPLETED SUCCESSFULLY")
print("=" * 60)
