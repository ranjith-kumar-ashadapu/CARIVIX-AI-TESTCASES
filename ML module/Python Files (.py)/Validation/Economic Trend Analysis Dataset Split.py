# ==========================================
# ECONOMIC TREND DATASET SPLITTING
# ==========================================
...
input_file = (
    ...
    r"\Economic_Trend_Feature_Engineering"
    r"\Economic_Trend_Feature_Engineered.csv"
)
...
print("=" * 60)
print("ECONOMIC TREND DATASET SPLITTING")
print("=" * 60)
...
overlap_count = (
    len(train_hashes.intersection(validation_hashes))
    + len(train_hashes.intersection(test_hashes))
    + len(validation_hashes.intersection(test_hashes))
)

if overlap_count > 0:
    raise ValueError(
        "Duplicate records found across the splits."
    )

print("\nNo duplicate records found across the splits.")
...
train_file = os.path.join(
    output_folder,
    "Economic_Trend_Train.csv"
)

validation_file = os.path.join(
    output_folder,
    "Economic_Trend_Validation.csv"
)

test_file = os.path.join(
    output_folder,
    "Economic_Trend_Test.csv"
)
...
print("\n" + "=" * 60)
print("ECONOMIC TREND SPLITTING COMPLETED SUCCESSFULLY")
print("=" * 60)
